...
public class MeasurementExperimentHandler extends ExperimentHandler<MeasurementTrial> {
    @Override
    public MeasurementTrial trialFromDatabase(QueryDocumentSnapshot doc) {
        ...
        return new MeasurementTrial(trialId,trialTitle,date,resultLong);
    }

    @Override
    public ArrayAdapter<Trial> getListAdapter(AppCompatActivity activity,
                                              ArrayList<Trial> trialDataList) {
        return new CustomMeasurementTrialList(activity, trialDataList);
    }

    @Override
    public String getType() {
        return ExperimentTypes.MEASUREMENT_STRING;
    }
    ...
    @Override
    public MeasurementTrial trialFromMap(Map<String, Object> data, String id) {
        String title = (String) data.get("Title");
        String date = (String) data.get("Date");
        long count = (long) data.get("Result");
        return new MeasurementTrial(id, title, date, count);
    }
