...
public class BinomialExperimentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subscribed_users_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent searchIntent = new Intent(BinomialExperimentActivity.this,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            updateExperimentDoc.update("Status", status).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(BinomialExperimentActivity.this, "Experiment Ended", Toast.LENGTH_LONG).show();
                                    } else {
                                        Toast.makeText(BinomialExperimentActivity.this, "Experiment not Ended", Toast.LENGTH_LONG).show();
                                    }
    ...
    private void getSubscribedUsers(){
        ...
        subUsersList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(BinomialExperimentActivity.this, SubscribedUserActivity.class);
    ...
    private void createTrialFromCommands(List<String> result) {
        ...
        collectionReference
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        trialDataList.add(new BinomialTrial(trialId, result.get(0), result.get(2)));
                        trialArrayAdapter.notifyDataSetChanged();
                        Toast.makeText(BinomialExperimentActivity.this, "Trial added", Toast.LENGTH_LONG).show();
                    }
                })
