...
public class SubscribedNonNegativeExperimentActivity extends AppCompatActivity implements
    ...
    /**
     * checks if the experiment has already ended.
     */
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                if ("closed".equals(status)) {
                                    ...
                                    Toast.makeText(SubscribedNonNegativeExperimentActivity.this, "Experiment has Ended", Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                    }
    ...
    /**
     * checks if the user is a subscriber or not.
     */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==2)
        {
            ...
            if(data!=null) {
                ...
                if(!s2.equals("NON_NEGATIVE_TRIAL"))
                    return;
    ...
    private void addTrial() {
            ...
            public void onClick(View v) {
                ...
                collectionReference
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                trialDataList.add(new NonNegativeIntegerTrial(trialId, title, Long.parseLong(result)));
                                trialArrayAdapter.notifyDataSetChanged();
        ...
        saveTrialDialogButton.setOnClickListener(v -> {
            if(addTrialDialogButton.isEnabled()) {
                Long result = Long.parseLong(addTrialResult.getText().toString());
                String title = addTrialTitle.getText().toString();
                // add to firebase
    ...
    private void createTrialFromCommands(List<String> result) {
        ...
        collectionReference
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        trialDataList.add(new NonNegativeIntegerTrial(trialId, result.get(0), Long.parseLong(result.get(2))));
                        trialArrayAdapter.notifyDataSetChanged();
                        Toast.makeText(SubscribedNonNegativeExperimentActivity.this, "Trial added", Toast.LENGTH_LONG).show();
                    }
                })
