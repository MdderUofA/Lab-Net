...
public class NonNegativeExperimentHandler extends ExperimentHandler<NonNegativeIntegerTrial> {
    @Override
    public NonNegativeIntegerTrial trialFromDatabase(QueryDocumentSnapshot doc) {
        ...
        return new NonNegativeIntegerTrial(trialId,trialTitle,date,resultLong);
    }

    @Override
    public ArrayAdapter<Trial> getListAdapter(AppCompatActivity activity,
                                              ArrayList<Trial> trialDataList) {
        return new CustomNonNegativeTrialList(activity, trialDataList);
    }

    @Override
    public String getType() {
        return ExperimentTypes.NON_NEGATIVE_NUMBER_STRING;
    }
    ...
    @Override
    public NonNegativeIntegerTrial trialFromMap(Map<String, Object> data, String id) {
        String title = (String) data.get("Title");
        String date = (String) data.get("Date");
        long count = (long) data.get("Result");
        return new NonNegativeIntegerTrial(id, title, date, count);
    }
